    ...
    <section className="w-full app-container py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-xl transition">
          <FaHome className="text-4xl text-red-600 mb-4" />
          <h2 className="text-xl font-semibold mb-2 text-red-600">Buying Guide</h2>
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-xl transition">
          ...
          <h2 className="text-xl font-semibold mb-2 text-red-600">Selling Guide</h2>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-xl transition">
          <FaCalculator className="text-4xl text-red-600 mb-4" />
          <h2 className="text-xl font-semibold mb-2 text-red-600">Property Calculator</h2>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 hover:shadow-xl transition">
          <FaQuestionCircle className="text-4xl text-red-600 mb-4" />
          <h2 className="text-xl font-semibold mb-2 text-red-600">FAQs</h2>
          <p className="text-gray-600 mb-4">
      ...
      <div className="mt-20 bg-gray-50 rounded-3xl p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-2xl shadow">
            <MdLocationOn className="text-3xl text-red-600 mb-3" />
          ...
          <div className="bg-white p-6 rounded-2xl shadow">
            <FaBook className="text-3xl text-red-600 mb-3" />
            <h3 className="text-xl text-red-600 font-semibold mb-2">
